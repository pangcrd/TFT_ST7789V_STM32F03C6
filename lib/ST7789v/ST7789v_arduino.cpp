...
static const uint8_t PROGMEM
  cmd_240x240[] = {                     // Initialization commands for 7789 screens
    ...
    // (ST7789_TFTHEIGHT+ST7789_240x240_YSTART) & 0xFF,  // YEND = 240
          ...
          0x00, ST7789_240x320_XSTART,          // XSTART = 0
    (ST7789_TFTWIDTH+ST7789_240x320_XSTART) >> 8,
    (ST7789_TFTWIDTH+ST7789_240x320_XSTART) & 0xFF,   // XEND = 240
    ST7789_RASET  , 4,            // 6: Row addr set, 4 args, no delay:
      0x00, ST7789_240x320_YSTART,          // YSTART = 0
      (ST7789_TFTHEIGHT+ST7789_240x320_YSTART) >> 8,
    (ST7789_TFTHEIGHT+ST7789_240x320_YSTART) & 0xFF,  // YEND = 240
